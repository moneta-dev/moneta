...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("MONETA version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  monetad [options]                     " + "\n" +
                  "  monetad [options] <command> [params]  " + _("Send command to -server or monetad") + "\n" +
                  "  monetad [options] help                " + _("List commands") + "\n" +
                  "  monetad [options] help <command>      " + _("Get help for a command") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (fDaemon)
        fprintf(stdout, "MONETA server starting\n");
